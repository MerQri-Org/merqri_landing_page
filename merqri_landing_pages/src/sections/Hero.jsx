...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="container mx-auto px-4 py-16 text-center font-lato">
      <img src={imageLeft} className="absolute left-0 top-32 h-4/6 opacity-60 hidden md:block" alt="Left Image " />
      <img src={imageRight} className="absolute right-40 top-80 h-16 opacity-60 hidden md:block" alt="Right Image" />
        ...
        <p className="text-sm text-secondary text-center md:text-xl ">
          Your smooth move starts here. Unlock the best moving experience  <br /> with
          our curated list of top-notch moving companies. Let&apos;s <br /> make your
