...
const AboutUs = () => {
  return (
    <section className="flex mx-20 justify-between py-16">
      ...
      <div className="relative mr-[10rem] mt-10">
        <div className=" ">
          <img src="/images/about1.png" alt="" />
        </div>
        <div className=" absolute top-[7rem] -right-40">
